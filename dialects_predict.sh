...
taskset -c 0-19 python3 extract_features.py dialects models/dialects-may --word "[1,2]" --char "[1,2,3,4,5]"
taskset -c 0-19 python3 feature_correlation.py models/dialects-may
taskset -c 0-19 python3 prepare_folds.py models/dialects-may 10
