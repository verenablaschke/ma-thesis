...
for i in $(seq 0 9); do
    ...
    screen -S tweets-attn-$i -X stuff "python3 predict_fold.py models/tweets-attn tweets $i --embed --log --mlm ffnn-attn rnn-attn --h 128 --ep 35 --b 64 --lr 0.01 0.01 --drop 0.4 --embmod word2vec --emblen 60\n"
done
