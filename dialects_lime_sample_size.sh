...
"
screen -S dialects0 -X stuff "python3 predict_fold.py models/dialects-z tweets 0 --save --z 1000 --out '1000-0' --limefeat 20
"
...
#     screen -S dialects$i -X stuff "python3 predict_fold.py models/dialects-z dialects 0 --load --z 1000 --out '1000-$i' --limefeat 20
# "
# done
