...
taskset -c 0-19 python3 predict_fold.py models/tweets-multi tweets 5 --embed --log --nolime --mlm rnn-attn --h 128 256 --ep 5 15 25 35 --b 128 --lr 0.001 0.01 --drop 0.0 0.2 0.4 --embmod bert-base-multilingual-cased --emblen 60
